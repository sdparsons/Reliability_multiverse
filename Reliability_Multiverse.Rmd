...
write.csv(estimates_removals_all,
          "Supplimental/S1_all_estimates.csv")
...
sup_est <- read.csv("Supplimental/S2_all_estimates_half_trials.csv")
...
full_ms <- read.csv("Supplimental/S1_all_estimates.csv")
sup_est <- read.csv("Supplimental/S2_all_estimates_half_trials.csv")
...
#estimates_removals_all <- read.csv("Supplimental/S1_all_estimates.csv")
